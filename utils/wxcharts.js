...
var config = {
    ...
    columePadding: 3,
    fontSize: 10,
    dataPointShape: ['diamond','circle', 'rect', 'triangle'],
    colors: ['#7ED321','#4A90E2','#434348', '#90ed7d', '#f15c80', '#8085e9'],
...
function drawToolTip(textList, offset, opts, config, context) {
    ...
    var toolTipWidth = legendWidth + legendMarginRight + 4 * config.toolTipPadding + Math.max.apply(null, textWidth) +14;
