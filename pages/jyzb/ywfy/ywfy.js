...
Page({
  ...
  onLoad: function (options) {
            ...
            if ( data.code == 100 ) {
                ...
                for (let index = 0; index < dataList.length; index++) {
                    ...
                    dataList[index].data_01 = utils.dataEmptyZero(dataList[index].data_01) == true?" ":parseFloat(dataList[index].data_01).toFixed(0)
                        ...
                        dataList[index].data_02 = utils.dataEmptyZero(dataList[index].data_02) == true?" ":parseFloat(dataList[index].data_02).toFixed(0)

                        dataList[index].data_03 = utils.dataEmptyZero(dataList[index].data_03) == true?" ":parseFloat(dataList[index].data_03).toFixed(0)+"%"
                        dataList[index].data_04 = utils.dataEmptyZero(dataList[index].data_04) == true?" ":parseFloat(dataList[index].data_04).toFixed(0)+"%"
    ...
    changeDataCode(e){
        ...
        console.log(name)
        let unit = "万元"
        console.log(name.indexOf("占比"))
        if(ind_code == "data_03" || name.indexOf("占比")!= -1){
          unit = "百分比"
        }
